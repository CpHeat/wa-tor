...
class PersistenceHandler(ABC):
    ...
    def create_ddb(cls):
        ...
        try:
            ...
            simulation_table_creation_request = """
            ...
            # Create simulation_detail table
            simulation_detail_table_creation_request = """
            ...
            # Create simulation_entities table
            simulation_entities_table_creation_request = """
